...
DungeonEntrance SHALL display a list of all dungeons from DungeonRegistry, showing each dungeon's name, map size (e.g. "16x16"), and exploration percentage.

#### Scenario: Empty list
- **WHEN** DungeonRegistry has no dungeons
- **THEN** the list area SHALL be empty
