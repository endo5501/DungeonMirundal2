...
- [x] 8.1 タイトル画面表示時にSaveManager.get_last_slot() と has_saves() を確認し、「前回から」「ロード」の有効/無効を切り替える
- [x] 8.2 「前回から」選択時にcontinue_gameシグナルを発行し、main.gdで最終セーブをロードする
- [x] 8.3 「ロード」選択時にload_gameシグナルを発行し、main.gdでロード画面を表示する
- [x] 8.4 ロード画面からタイトル画面に戻る操作を実装する
