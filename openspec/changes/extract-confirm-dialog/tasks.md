...
- [ ] 7.1 `godot --headless -s addons/gut/gut_cmdln.gd` でフルテストスイート通過
- [ ] 7.2 ゲーム起動 → 各ダイアログを目視確認:
  - START タイル上で帰還ダイアログ
  - ダンジョン入口で削除確認
  - セーブ画面で上書き確認
  - ESC で終了確認
- [ ] 7.3 ショップで購入・売却モードのリスト操作を確認

## 8. 仕上げ

- [ ] 8.1 `openspec validate extract-confirm-dialog --strict`
- [ ] 8.2 `/opsx:verify extract-confirm-dialog`
- [ ] 8.3 `/opsx:archive extract-confirm-dialog`
