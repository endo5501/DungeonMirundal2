...
- [ ] 7.2 `godot --headless -s addons/gut/gut_cmdln.gd` でフルテストスイートが通ることを確認
- [ ] 7.3 `/opsx:verify make-dungeon-tests-deterministic`
- [ ] 7.4 `/opsx:archive make-dungeon-tests-deterministic`
