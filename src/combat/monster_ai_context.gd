class_name MonsterAiContext
extends RefCounted

# Snapshot of battle state passed to MonsterAi.choose. The AI SHALL NOT mutate
...
var status_repo: StatusRepository
...
func _init(
	...
	p_status_repo: StatusRepository,
	p_turn_engine: TurnEngine,
) -> void:
	party = p_party
	monsters = p_monsters
	spell_repo = p_spell_repo
	status_repo = p_status_repo
